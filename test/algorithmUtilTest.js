...
describe("algorithmUtil", () => {
    it("formExecutePaths", async () => {
        ...
        const result = algorithmUtil.formExecutePaths(xuanPinHuiForm, {name: "1", children: []}, [])
        ...
        const result1 = algorithmUtil.formExecutePaths(xuanPinHuiForm1, {name: "1", children: []}, [])
        ...
        // const result2 = algorithmUtil.formExecutePaths(tmForm, {name: "1", children: []}, [])
        // console.log(result2)
    })
})
