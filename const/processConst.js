...
const createTypeLeaves = (baseField) => ([
    {header: '正推数量', field: `${baseField}_supplier`, hasChild: false},
    {header: '反推数量', field: `${baseField}_operator`, hasChild: false},
    {header: 'IP数量', field: `${baseField}_ip`, hasChild: false},
    {header: '自研数量', field: `${baseField}_self`, hasChild: false},
])

const createDivisionTypeNodes = (baseField) => [1, 2, 3].map((index) => ({
    header: `事业${index}部`,
    field: `${baseField}${index}`,
    hasChild: true,
    children: createTypeLeaves(`${baseField}${index}`),
}))
...
const createSelectionResult = () => ({
    ...
    children: [
        ...
        {header: '选中', field: 'choose', hasChild: true, children: createDivisionTypeNodes('choose_division')},
        {header: '未选中', field: 'unchoose', hasChild: true, children: createDivisionTypeNodes('unchoose_division')},
    ],
})

const createShelfColumns = () => ({
    header: '上架数量',
    field: 'shelf',
    hasChild: true,
    children: [
        {header: '未上架', field: 'unshelf', hasChild: true, children: createDivisionTypeNodes('unshelf_division')},
        {header: '已上架', field: 'shelfed', hasChild: true, children: createDivisionTypeNodes('shelfed_division')},
    ],
})
        ...
        children: [
            {
                ...
                field: 'unshelf',
                hasChild: true,
                children: createDivisionTypeNodes('unshelf_division'),
            },
        ],
    },
]
...
const defaultColumns = [
    ...
    {header: '一级类目', field: 'l1categories'},
    {header: '二级类目', field: 'l2categories'},
    {header: '三级类目', field: 'l3categories'},
    ...
    {header: '北京设计草图', field: 'bj_design_image'},
    {header: '杭州设计草图', field: 'hz_design_image'},
    ...
    {header: '立项是否通过', field: 'project_approval_status'},
    {header: '开发负责人', field: 'development_leader'},
    {header: '是否在聚水潭建立产品信息', field: 'jushuitan_product_created'},
    {header: '样品确认', field: 'sample_confirmation_status'},
    {header: '杭州样品快递单号', field: 'hangzhou_sample_tracking_number'},
    {header: '产品厂图+白膜信息在线链接', field: 'product_factory_diagram_link'},
    {header: '事业一部运营', field: 'business_unit1_operator'},
    {header: '事业二部运营', field: 'business_unit2_operator'},
    {header: '事业三部运营', field: 'business_unit3_operator'},
    {header: '采购执行人', field: 'purchase_executor'},
    {header: '采购订货合同', field: 'purchase_contract'},
    {header: '预计到货时间', field: 'estimated_arrival_date'},
    {header: '问题是否解决', field: 'issue_resolved'},
    {header: '货品到仓时间', field: 'goods_warehouse_arrival_date'},
    {header: '货品质检', field: 'goods_quality_check'},
    {header: '发往南京库房最终样品', field: 'final_sample_to_nanjing'},
    {header: '是否跟封样一致', field: 'matches_sealed_sample'},
    {header: '预计订货量', field: 'estimated_order_quantity'},
    {header: '北京设计执行人', field: 'beijing_design_executor'},
    {header: '杭州设计执行人', field: 'hangzhou_design_executor'},
    {header: '设计完整执行人', field: 'design_complete_executor'},
    {header: '选择确认使用设计草图', field: 'confirmed_design_draft'},
    {header: '产品及包装设计周期', field: 'design_cycle_period'},
    {header: '上传定稿图以及上传联图云', field: 'final_design_upload'},
    {header: '产品采购', field: 'product_procurement'},
    {header: '选择做爆款方案的事业部', field: 'hot_sale_business_unit'},
    {header: '需要美编还是视觉', field: 'need_designer_or_visual'},
    {header: '整理产品信息', field: 'product_info_organized'},
    {header: '链接主销编码', field: 'link_main_sales_code'},
    {header: '链接属性', field: 'link_attribute'},
    ...
    {header: '周转预计走货时间', field: 'turnover_estimate_shipment_date'},
    {header: '周转预计到仓时间', field: 'turnover_estimate_arrival_date'},
    {header: '事业一部样品是否选中', field: 'business_unit1_sample_selected'},
    {header: '事业二部样品是否选中', field: 'business_unit2_sample_selected'},
    {header: '事业三部样品是否选中', field: 'business_unit3_sample_selected'},
    {header: '难易度', field: 'difficulty_level'},
    {header: '体量目标', field: 'volume_target'},
