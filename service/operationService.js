...
const updateInventory = async () =>{
    ...
    await goodsSalesRepo.updateNJsaleqty(7,'a.nj7_sale_qty')
    await goodsSalesRepo.updateNJsaleqty(30,'a.nj30_sale_qty')
    await goodsSalesRepo.updateJDsaleqty(7,'a.jd7_sale_qty')
    await goodsSalesRepo.updateJDsaleqty(30,'a.jd30_sale_qty')
