...
const { bpmDbConfig } = require('../config/index')
...
const pool = mysql.createPool({
    ...
    queueLimit: 0,
    host: bpmDbConfig.host,
    user: bpmDbConfig.username,
    password: bpmDbConfig.password,
    database: bpmDbConfig.dbName,
    port: bpmDbConfig.port,
    dateStrings: true,
})
